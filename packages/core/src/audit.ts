...
export const ENTITY_TYPES = ["visit", "visit_reservation", "task", "assistance_request", "robot", "command", "resident", "user", "device", "family_link", "staff_assignment", "tool"] as const;
